      ...
      Body={
        <div className={"Example Page"}>
          <Paragraph>
            ...
            blazing fast and lots of interesting stuff are coming, my friends
            and colleagues started asking me more about how they can start with
            React and how they should think in the React way.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            possible. All the snippets and post related code are available in
            the{" "}
            <Link
...
"
          ...
          <Paragraph>
            If you are already familiar with React and you understand the
            basics, like the concept of virtual DOM and thinking in components,
            then this React.js tutorial is probably not for you. We will discuss
          ...
          <Paragraph>
            ...
            When a problem becomes challenging, you can break it down into
            smaller ones and solve it there. You can also reuse it somewhere
            else later. Think of it like the bricks of Lego. We will discuss
            component-driven development more deeply in this article later.
          </Paragraph>
          <Paragraph>
            React also has this virtual DOM thing, what makes the rendering
            super fast but still keeps it easily understandable and controllable
            at the same time. You can combine this with the idea of components
            and have the power of top-down rendering. We will cover this topic
            in the second article.
          </Paragraph>
          <Paragraph>
            Ok I admit, I still didn’t answer the question. We have components
            and fast rendering – but why is it a game changer? Because React is
            mainly a concept and a library just secondly.
          </Paragraph>
          <Paragraph>
            ...
            concept, React has it’s own solutions, tools and libraries turning
            it into an ecosystem. In this ecosystem, you have to pick your own
            tools and build your own ~framework. I know it sounds scary but
            believe me, you already know most of these tools, we will just
            connect them to each other and later you will be very surprised how
            easy it is. For example for dependencies we won’t use any magic,
            rather Node’s require and npm. For the pub-sub, we will use Node’s
            EventEmitter and as so on.
          </Paragraph>
